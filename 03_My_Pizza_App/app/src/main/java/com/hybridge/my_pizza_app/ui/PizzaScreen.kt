...
fun PizzaScreen(viewModel: PizzaViewModel = viewModel()) {
    ...
    Column(
        ...
        Card(shape = RoundedCornerShape(12.dp),
            ...
            viewModel.refreshPizza() //Accion que realiza el boton
        }
            ...
            Row(
                ...
                Column {
                    Text(pizza.type, fontSize = 18.sp, fontWeight = FontWeight.Bold)
                    Spacer(modifier = Modifier.height(4.dp))
                    Text("Precio: $${pizza.price}", fontSize = 16.sp, color = Color.Gray)
                }
